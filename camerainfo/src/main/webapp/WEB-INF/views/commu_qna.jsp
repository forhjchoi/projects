	...
	<div id="location">
		<div class="box_960">
			<span>
				...
				<img class="arrow" src="img/img_arrow_location.gif" alt="" width="12" />
				<span class="stay"><span><b> 질문과답변</b></span></span>
			</span>
		</div>
	</div>
...
<div id="contents">
		...
		<div class="box_960_sub ">
			<h1 class="page_tit" style="letter-spacing:0;">질문과답변 <span></span></h1>
			<!-- 본문 영역 -->
			<div id="press_list">			
				<div class="search">
				...
				<table class="press">
					...
					<tr>
						...
						<td class="align_l" style="text-align:center;">
							<a href="commu_qna_read.do?num=${qna.idx }">${qna.title }</a>
						</td>
						<td>${qna.name }</td>
						<td class="bdr0">${qna.hits }</td>
					</tr>
					</c:forEach>	  
				</table>
				...
				<div class="pager">
					...
					<div class="page_move">
						<c:if test="${memberInfo.id != null }">
							<span><a href="#">&lt;</a></span>
							<div class="search">
								<a href="commu_write.do" class="searching">등록</a>	
							</div>
						</c:if>					 
					</div>
				</div>
