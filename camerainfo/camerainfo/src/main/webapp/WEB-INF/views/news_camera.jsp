...
<div id="contents">
		...
		<div class="box_960_sub ">
			<h1 class="page_tit" style="letter-spacing:0;">뉴스 <span>Camera News</span></h1>
					...
					<ul class="lecture_list">					
						...
						<c:forEach var="board" items="${boardList }">
							<li  class="bdb0">
								...
								<div class="btns">
									<a href="news_camera_read.do?newsNum=${board.getNum() }" class="details">상세보기</a>							
								</div>
							</li>
						</c:forEach>
	<%
	...
	%>					
								<div class="pager">
									...
									<c:forEach var="i" begin="1" end="${t_pages }">
										<span class="selected">
											<a href="news_camera.do?current_page=${i }">
