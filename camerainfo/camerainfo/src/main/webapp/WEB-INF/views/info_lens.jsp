...
<div id="contents">
		...
		<div class="box_960_sub ">
			<h1 class="page_tit" style="letter-spacing:0;">
				렌즈 제품 정보                     <span >Product Information</span>
			</h1>
			...
			<div id="product_list">
				...
				<ul class="tabMenu menu04">
					<li class="on"><a href="info_lens.do?current_page=1&br=0">니콘</a></li>
					<li class="on"><a href="info_lens.do?current_page=1&br=1">캐논</a></li>
					<li class="on"><a href="info_lens.do?current_page=1&br=2">삼성</a></li>
				</ul>
				<!-- //탭메뉴 --><!-- 제품 목록 -->
					...
					<div class="prod_list prod_list_dslr">
						﻿<ul>
							...
							<li class="released_1 FX">
								<span class="img"><a href="info_lens_read.do?num=${info.num }"><img src="upload_info/${info.pic }" alt="" /></a></span>
								<span class="txt"  onclick=".">
									<h2 align="center">${info.name }</h2>
								</span>
							</li>		
							</c:forEach>
							<%
							...
							%>					
								<div class="pager">
									...
									<c:forEach var="i" begin="1" end="${t_pages }">
										<span class="selected">
											<a href="info_lens.do?current_page=${i }">
						...
						<c:if test="${memberInfo.id == adm }">
							...
							<a href="info_lens_write.do" class="details" style="position:absolute; bottom:0; right:0"><h1>제품 등록</h1></a>
						</c:if>							
						</div>
